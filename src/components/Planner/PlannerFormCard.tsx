...
const categories:GroceryCategory[] = ["Produce", "Dairy", "Bakery", "Snacks", "Pantry"];
...
const categoryIcons = {
  ...
  "Dairy": "cow",
  "Bakery": "bread-slice",
  "Snacks": "cookie-bite",//test cookie-bites
  "Pantry": "box-open"
};
  ...
  return (
    <View className="rounded-3xl border border-border bg-card p-4">
      ...
      <View className="mt-2 flex-row items-center rounded-2xl border border-border bg-muted px-4 py-3">
        ...
        <Pressable
          className={`mt-5 flex-row items-center justiify-center rounded-2xl py-3 ${
