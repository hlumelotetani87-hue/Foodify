...
export const ListHeroCard = () => {
    ...
    return (
        <View className="rounded-3xl bg-primary p-5">
            <Text className="text-sm font-semibold uppercase tracking-[1px] text-primary-foreground/78">
                Today
            </Text>
        
            <Text className="mt-1 text-3xl text font-extrabold text-primary-foreground">
                Your Grocery Board
            </Text>
